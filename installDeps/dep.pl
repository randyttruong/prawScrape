...
sub installDep() {
  ...
  system "pip install ./v1.2.3.zip --break-system-packages";
  ...
  system "pip install ./v2.4.0.zip --break-system-packages";
  ...
  system "pip install intel_openmp-2021.4.0-py2.py3-none-manylinux1_x86_64.whl --break-system-packages";
  print "Cleaning up intel-openmp 2021.4.0 \n";
  system "rm -rf intel_openmp-2021.4.0-py2.py3-none-manylinux1_x86_64.whl --break-system-packages";
  print "Finished installing intel-openmp 2021.4.0 \n";

  sleep(2);
  print "Installing mkl 2021.4.0 \n";
  system "pip install mkl==2021.4.0 --break-system-packages";
